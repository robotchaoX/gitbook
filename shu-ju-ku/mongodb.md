...
![](media/image1.png){width="5.999305555555556in" height="2.3583333333333334in"}
...
<span id="_1539778490" class="anchor"><span id="_1540120705" class="anchor"><span id="_1539778472" class="anchor"><span id="_1540101520" class="anchor"><span id="_1544540259" class="anchor"><span id="_1541312256" class="anchor"></span></span></span></span></span></span>

<https://www.cnblogs.com/darklights/p/9900794.html>
...
db.COLLECTION\_NAME.find({COND},{FIELDS})
...
**DBClientConnection(bool auto\_connect, 0, double so\_timeout);**

auto\_connect(IN)：连接失败后自动重连

so\_timeout(IN)：非连接超时，tcp的读写超时
...
bool auto\_connect = true;

double so\_timeout = 3;
...
DBClientConnection pConn = new DBClientConnection(auto\_connect, 0, so\_timeout);

pConn-&gt;connect(host+":"+port, errmsg);

3.查询

**auto\_ptr query(const string &ns, Query query, int nToReturn, int nToSkip,\
